...
Sector file for Lebanon at VATME. Compatible with the Euroscope radar client only. Not tested with VRC so it may or may not work with VRC.
...
5. Browse to the folder where you extracted the zip file in step 3 and choose the OLBB.prf file
